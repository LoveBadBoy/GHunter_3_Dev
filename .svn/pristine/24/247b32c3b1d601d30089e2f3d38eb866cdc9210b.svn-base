...
//    toolContainerView.backgroundColor       = [UIColor lightGrayColor];
    ...
    [titleButton setTitleColor:Nav_backgroud forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    _titleButton.width                      = mainScreenWidth;
    ...
    CGFloat tableContainerViewY             = CGRectGetMaxY (_toolContainerView.frame) ;
    ...
    _indicatorView.layer.borderColor = [[UIColor grayColor] CGColor];
    _indicatorView.frame   = CGRectMake(0, inset*self.cellHeight, mainScreenWidth, self.cellHeight);
    CGRect  _tableContainerfram =  _tableContainerView.frame ;
    _tableContainerfram.origin.y = 0;
    _tableContainerView.frame  = _tableContainerfram;
    _tableContainerView.backgroundColor = [UIColor whiteColor];
    
    CGRect _toolViewframe = _toolView.frame;
    _toolViewframe.origin.y = _tableContainerfram.size.height;
    _toolView.frame = _toolViewframe;
