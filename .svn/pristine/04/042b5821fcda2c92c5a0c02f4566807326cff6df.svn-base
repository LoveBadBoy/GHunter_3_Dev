...
- (void)loadMoreDataToTable
{
    if (self.currentPage.integerValue == 0) {
        ...
        [self didGetTaskListIsloading:NO withPage:[[moreDataArray objectAtIndex:self.currentPage.integerValue] integerValue] andType:self.taskType andCatalogID:_taskCid];
    }else{
