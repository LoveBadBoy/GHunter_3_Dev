...
//    self.payView.layer.cornerRadius = Radius;
    tradeNum = @"";
    RadioButton *rb1 = [[RadioButton alloc] initWithGroupId:@"recharge group" index:0 normalImage:[UIImage imageNamed:@"radio_normal"] clickedimage:[UIImage imageNamed:@"define_tag"] isLeft:NO size:CGSizeMake(40, 40) padding:12.0];
    rb1.frame = CGRectMake(mainScreenWidth - 50,5, 40, 40);
    ...
    RadioButton * rb2 = [[RadioButton alloc] initWithGroupId:@"recharge group" index:1 normalImage:[UIImage imageNamed:@"radio_normal"] clickedimage:[UIImage imageNamed:@"define_tag"] isLeft:NO size:CGSizeMake(40, 40) padding:12.0];
    rb2.frame = CGRectMake(mainScreenWidth - 50, 5, 40, 40);
