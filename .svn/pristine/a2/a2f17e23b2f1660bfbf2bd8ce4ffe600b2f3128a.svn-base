...
#define kDefaultBadgeBackgroundColor [UIColor colorWithRed:234/255.0 green:85/255.0 blue:20/255.0 alpha:1.0]

#define kDefaultBadgeTextFont [UIFont boldSystemFontOfSize:11.0]

#define kDefaultBadgeShadowColor [UIColor clearColor]

#define kBadgeStrokeColor [UIColor colorWithRed:234/255.0 green:85/255.0 blue:20/255.0 alpha:1.0]
#define kBadgeStrokeWidth 1.5f

#define kMarginToDrawInside (kBadgeStrokeWidth * 5)
...
- (id)initWithParentView:(UIView *)parentView alignment:(JSBadgeViewAlignment)alignment width:(CGFloat)width height:(CGFloat)height
{
    _width = width;
    _height = height;
...
{    
    ...
    if(_width > 10){
        ...
        viewWidth = _width + (kMarginToDrawInside * 2);
    }
    CGFloat viewHeight = _height + (kMarginToDrawInside * 2);
