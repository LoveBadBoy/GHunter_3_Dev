...
@interface ghunterSkillViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,PullTableViewDelegate,UIActionSheetDelegate,UITextViewDelegate, UITextFieldDelegate,ABNewPersonViewControllerDelegate,UIGestureRecognizerDelegate,ImgScrollViewDelegate,UIScrollViewDelegate,SOLoopViewDelegate,ZYQAssetPickerControllerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate, OHAttributedLabelDelegate>{
