...
@property (strong, nonatomic) IBOutlet UIButton *exchangeBt;
...
//    self.rechargeBt.clipsToBounds = YES;
    self.exchangeBt.layer.cornerRadius = 2;
    self.rechargeBt.layer.cornerRadius = 2;
...
//    self.withdraw.layer.cornerRadius = Radius;
    ...
    self.balanceView.frame = CGRectMake(0, 0, self.view.frame.size.width, self.balanceView.frame.size.height);
    self.accountBG.frame = CGRectMake(0, self.balanceView.frame.origin.y + self.balanceView.frame.size.height + 10, self.view.frame.size.width, self.accountBG.frame.size.height);
    self.rechargeBt.frame = CGRectMake(self.view.frame.size.width - 10 -  self.rechargeBt.frame.size.width, 11, self.rechargeBt.frame.size.width, self.rechargeBt.frame.size.height);
    self.withdraw.frame = CGRectMake(self.view.frame.size.width - 10 - self.rechargeBt.frame.size.width - 10 - self.withdraw.frame.size.width,11, self.withdraw.frame.size.width, self.withdraw.frame.size.height);
    self.goldBalanceView.frame = CGRectMake(0, self.accountBG.frame.size.height + self.accountBG.frame.origin.y + 10, self.view.frame.size.width, 66);
